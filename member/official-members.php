...
<head>
    ...
    <title>THÀNH VIÊN CHÍNH THỨC | STEAM BINH LONG</title>
        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarNavDropdown">
                <ul class="navbar-nav ms-auto ">
                    ...
                    <li class="nav-item">
                      <a href="/SBLC/update/updating.html" class="nav-link" aria-current="page">Dự án</a>
                    </li>
                    ...
                    <li class="nav-item dropdown">
                      ...
                      <ul class="dropdown-menu" id="datasheets" aria-labelledby="firmwaresMenu">
                          <li class="dropdown-item"><a href="/SBLC/update/updating.html" style="text-decoration: none; color: blue; font-weight: 600;">Arduino IDE</a></li>
                          <li class="dropdown-item"><a href="/SBLC/update/updating.html" style="text-decoration: none; color: blue;font-weight: 600">Arduino ESP32</a></li>
                      </ul>
                  </li>
                  <li class="nav-item dropdown">
                    ...
                    <ul class="dropdown-menu" id="datasheets" aria-labelledby="hardwaresMenu">
                        <li class="dropdown-item"><a href="/SBLC/update/updating.html" style="text-decoration: none; color: blue; font-weight: 600;">Driver</a></li>
                        <li class="dropdown-item"><a href="/SBLC/update/updating.html" style="text-decoration: none; color: blue;font-weight: 600">Chip</a></li>
                        <li class="dropdown-item"><a href="/SBLC/update/updating.html" style="text-decoration: none; color: blue; font-weight: 600;">Linh kiện</a></li>
                    </ul>
                </li>
                    <li class="nav-item">
                        <a href="/SBLC/about/about.html" class="nav-link">Giới thiệu</a>
                    </li>
                    <li class="nav-item">
                      <a href="/SBLC/join/contact.php" class="nav-link">Liên hệ</a>
                    </li>
    ...
    <div class="main-carousel">
        ...
        <div class="container-fluid d-flex">
                <div class="footer-carousel active">
                    <div class="wrapper">
                        <h2 class="header-title">Thành viên chính thức STEAM BINH LONG</h2>
                        <div id="load_official_member" style= "display: flex;flex-flow: column;height: 100%;padding: 20px;border-radius: 10px;">

                        </div>
                        <div class="footer">
                            <button class="btn btn-success"><a href="/SBLC/join/contact.php">Đăng ký</a></button>
                            <button class="btn btn-primary"><a href="/SBLC/member/processing-members.php">Đang chờ xét duyệt</a></button>
                        </div>
                    </div>
                </div>
            </div>
